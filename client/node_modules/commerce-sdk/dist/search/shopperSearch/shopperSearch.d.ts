...
* Last Updated: 2020-07-16T20:36:13.506Z<br />
* </span>
...
the product search hit. The search result contains only products that are online and assigned to site catalog.
  ...
  productSearch<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperSearch.ProductSearchResult>;
  /**
  ...
  getSearchSuggestions<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperSearch.SuggestionResult>;
}
