...
export declare namespace ShopperBaskets {
  type ErrorResponse = {
    type: string;
    title?: string;
    detail?: string;
...
*/
export declare class ShopperBaskets extends BaseClient {
...
attribute.
    ...
    *
    * @returns A promise of type ShopperBaskets.Basket.
    *
    */
  createBasket(options: {
    ...
    body: ShopperBaskets.Basket;
  }): Promise<ShopperBaskets.Basket>;
  /**
    * Creates a new basket.
...
attribute.
  ...
  createBasket<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperBaskets.Basket>;
  /**
   * Removes a basket.
   *
...
properties of the basket, and the shipping items will be considered.
   ...
   *
   */
  updateBillingAddressForBasket(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
    ...
    body: ShopperBaskets.OrderAddress;
  }): Promise<ShopperBaskets.Basket>;
  /**
   * Sets the billing address of a basket.
   *
  ...
  addCouponToBasket(options: {
    ...
    body: ShopperBaskets.CouponItem;
  }): Promise<ShopperBaskets.Basket>;
  /**
   * Adds a coupon to an existing basket.
   *
   ...
   *
   */
  removeCouponFromBasket(options?: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      couponItemId: string;
   ...
   *
   */
  updateCustomerForBasket(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      siteId?: string;
    ...
    body: ShopperBaskets.CustomerInfo;
  }): Promise<ShopperBaskets.Basket>;
  /**
   * Sets customer information for an existing basket.
   *
   ...
   *
   */
  addGiftCertificateItemToBasket(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      siteId?: string;
    ...
    body: ShopperBaskets.GiftCertificateItem;
  }): Promise<ShopperBaskets.Basket>;
  /**
   * Adds a gift certificate item to an existing basket.
   *
   ...
   *
   */
  removeGiftCertificateItemFromBasket(options?: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      giftCertificateItemId: string;
   ...
   *
   */
  updateGiftCertificateItemInBasket(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      giftCertificateItemId: string;
...
type of custom attribute defined for ProductLineItem.
  ...
  addItemToBasket(options: {
    ...
    body: Array<ShopperBaskets.ProductItem>;
  }): Promise<ShopperBaskets.Basket>;
  /**
    * Adds new items to a basket. The added items are associated with the
specified shipment. If no shipment id is specified, the added items are associated with the default shipment.
...
ProductLineItem.
  ...
  updateItemInBasket(options: {
    ...
    body: ShopperBaskets.ProductItem;
  }): Promise<ShopperBaskets.Basket>;
  /**
    * Updates an item in a basket. The
following values in the request body are considered by the server:
...
ProductLineItem.
   ...
   *
   */
  addPaymentInstrumentToBasket(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      siteId?: string;
    ...
    body: ShopperBaskets.BasketPaymentInstrumentRequest;
  }): Promise<ShopperBaskets.Basket>;
  /**
   * Adds a payment instrument to a basket.
   *
   ...
   *
   */
  removePaymentInstrumentFromBasket(options?: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      paymentInstrumentId: string;
   ...
   * sent with this request.
   *
   * @returns A promise of type ShopperBaskets.PaymentMethodResult.
   *
   */
  getPaymentMethodsForBasket(options?: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      siteId?: string;
  ...
  }): Promise<ShopperBaskets.PaymentMethodResult>;
  /**
   * Gets applicable payment methods for an existing basket considering the open payment amount only.
   *
   * @param options - An object containing the options for this method.
  ...
  getPaymentMethodsForBasket<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperBaskets.PaymentMethodResult>;
  /**
...
- custom properties
    ...
    *
    */
  createShipmentForBasket(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      siteId?: string;
...
It is not allowed to remove the default shipment.
    ...
    *
    */
  removeShipmentFromBasket(options?: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      shipmentId: string;
...
- custom properties
    ...
    *
    */
  updateShipmentForBasket(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      shipmentId: string;
...
- custom properties
   ...
   *
   */
  updateShippingAddressForShipment(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      shipmentId: string;
   ...
   *
   */
  updateShippingMethodForShipment(options: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      shipmentId: string;
    ...
    body: ShopperBaskets.ShippingMethod;
  }): Promise<ShopperBaskets.Basket>;
  /**
   * Sets a shipping method to a specific shipment of a basket.
   *
   ...
   * sent with this request.
   *
   * @returns A promise of type ShopperBaskets.ShippingMethodResult.
   *
   */
  getShippingMethodsForShipment(options?: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      shipmentId: string;
  ...
  }): Promise<ShopperBaskets.ShippingMethodResult>;
  /**
   * Gets the applicable shipping methods for a certain shipment of a basket.
   *
   * @param options - An object containing the options for this method.
  ...
  getShippingMethodsForShipment<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperBaskets.ShippingMethodResult>;
  /**
   ...
   * sent with this request.
   *
   * @returns A promise of type ShopperBaskets.Taxes.
   *
   */
  getTaxesFromBasket(options?: {
    parameters?: {
      organizationId?: string;
      basketId: string;
      siteId?: string;
  ...
  getTaxesFromBasket<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperBaskets.Taxes>;
  /**
