...
* Last Updated: 2020-07-16T20:29:37.377Z<br />
* </span>
...
export declare class GiftCertificates extends BaseClient {
 ...
 the same unique identifier is generated, it is deleted and a new one is created.
    ...
    *
    */
  createGiftCertificate<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        siteId?: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : GiftCertificates.GiftCertificate>;
  /**
...
## Notes:
  ...
  * Only searchable attributes can be used in sorting.
    ...
    *
    */
  giftCertificatesSearch<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        siteId?: string;
    ...
    T extends true ? Response : GiftCertificates.GiftCertificateSearchResult
  >;
  /**
   ...
   *
   */
  deleteGiftCertificate<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        merchantId: string;
   ...
   *
   */
  updateGiftCertificate<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        merchantId: string;
