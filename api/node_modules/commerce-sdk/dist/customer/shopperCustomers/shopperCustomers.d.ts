...
* Last Updated: 2020-07-16T20:34:54.581Z<br />
* </span>
...
export declare class ShopperCustomers extends BaseClient {
  ...
  registerCustomer<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperCustomers.Customer>;
  /**
...
mechanism.
  ...
  getResetPasswordToken<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperCustomers.ResetPasswordToken>;
  /**
  ...
  createCustomerAddress<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperCustomers.CustomerAddress>;
  /**
  ...
  getCustomerBaskets<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperCustomers.BasketsResult>;
  /**
  ...
  getCustomerOrders<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperCustomers.CustomerOrderResult>;
  /**
  ...
  createCustomerPaymentInstrument<T extends boolean>(
    ...
    T extends true ? Response : ShopperCustomers.CustomerPaymentInstrument
  >;
  /**
  ...
  getCustomerProductLists<T extends boolean>(
    ...
    T extends true ? Response : ShopperCustomers.CustomerProductListResult
  >;
  /**
  ...
  createCustomerProductList<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperCustomers.CustomerProductList>;
  /**
...
type of custom attribute defined for ProductListItem.
  ...
  createCustomerProductListItem<T extends boolean>(
    ...
    T extends true ? Response : ShopperCustomers.CustomerProductListItem
  >;
  /**
...
The value of this property must be valid for the type of custom attribute defined for ProductListItem.
  ...
  getPublicProductListsBySearchTerm<T extends boolean>(
    ...
    T extends true ? Response : ShopperCustomers.PublicProductListResult
  >;
  /**
  ...
  getPublicProductList<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : ShopperCustomers.PublicProductList>;
  /**
  ...
  getProductListItem<T extends boolean>(
    ...
    T extends true ? Response : ShopperCustomers.PublicProductListItem
  >;
}
