...
* Last Updated: 2020-07-16T20:33:16.466Z<br />
* </span>
...
export declare class Products extends BaseClient {
   ...
   *
   */
  deleteProduct<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
  ...
  getProduct<T extends boolean>(
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.Product>;
  /**
...
onlineFlag, defaultVariantId.
    ...
    *
    */
  updateProduct<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
   ...
   *
   */
  createProduct<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.Product | Products.Product>;
  /**
...
Sortable Fields:
  ...
  - attributes - Information related to product variation attributes is retrieved. This expand is not included by default.
    ...
    *
    */
  searchProductVariations<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.VariantSearchResult>;
  /**
   ...
   *
   */
  getVariationGroupsForMasterProduct<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.VariationGroups>;
  /**
  ...
  deleted: it remains as a normal product after unsassign.
    ...
    *
    */
  unassignVariationGroupFromMasterProduct<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
   ...
   *
   */
  getVariationGroupForMasterProduct<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.VariationGroup>;
  /**
   ...
   *
   */
  updateVariationGroupForMasterProduct<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
  ...
  one is created using the body passed in.
    ...
    *
    */
  assignVariationGroupToMasterProduct<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
   ...
   *
   */
  getVariationsForMasterProduct<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.Variants>;
  /**
  ...
  normal product after unsassign.
    ...
    *
    */
  unassignVariationFromMasterProduct<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
   ...
   *
   */
  getVariationForMasterProduct<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.Variant>;
  /**
   ...
   *
   */
  updateVariationForMasterProduct<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
  ...
  one is created using the body passed in.
    ...
    *
    */
  assignVariationForMasterProduct<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        masterProductId: string;
   ...
   *
   */
  getProductOptions<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.ProductOptions>;
  /**
   ...
   *
   */
  deleteProductOption<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
   ...
   *
   */
  getProductOption<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.ProductOption>;
  /**
   ...
   *
   */
  updateProductOption<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
   ...
   *
   */
  createProductOption<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    T extends true ? Response : Products.ProductOption | Products.ProductOption
  >;
  /**
   ...
   *
   */
  deleteProductOptionValue<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        id: string;
   ...
   *
   */
  getProductOptionValue<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        id: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.ProductOptionValue>;
  /**
   ...
   *
   */
  updateProductOptionValue<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        id: string;
   ...
   *
   */
  createProductOptionValue<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        id: string;
    ...
    T extends true
      ? Response
      : Products.ProductOptionValue | Products.ProductOptionValue
  >;
  /**
   ...
   *
   */
  getVariationAttributeValue<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.VariationAttributeValue>;
  /**
   ...
   *
   */
  deleteVariationAttributeValue<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
   ...
   *
   */
  updateVariationAttributeValue<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
  ...
  createVariationAttributeValue(options: {
    ...
    Products.VariationAttributeValue | Products.VariationAttributeValue
  >;
  /**
   * Action to create a product variation attribute value.
   *
   ...
   *
   */
  createVariationAttributeValue<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
   ...
   *
   */
  getVariationAttributes<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.VariationAttributes>;
  /**
   ...
   *
   */
  getVariationAttribute<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.VariationAttribute>;
  /**
   ...
   *
   */
  deleteVariationAttribute<T extends boolean>(
    options?: {
      parameters?: {
        organizationId?: string;
        productId: string;
  ...
  slicing
    ...
    *
    */
  updateVariationAttribute<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
   ...
   *
   */
  createVariationAttribute<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        productId: string;
    ...
    T extends true
      ? Response
      : Products.VariationAttribute | Products.VariationAttribute
  >;
  /**
...
- ‘bundles' retrieves the following properties:
    ...
    *
    */
  searchProducts<T extends boolean>(
    options: {
      parameters?: {
        organizationId?: string;
        siteId?: string;
    ...
    rawResponse?: T
  ): Promise<T extends true ? Response : Products.ProductSearchResult>;
}
