...
const normalizeUrl = (urlString) => {
    const parsed = new url_1.default.URL(urlString);
 ...
 */
const makeCacheKey = (req) => normalizeUrl(req.url);
...
const matchDetails = (req, cached) => {
    const reqUrl = new url_1.default.URL(normalizeUrl(req.url));
    const cacheUrl = new url_1.default.URL(normalizeUrl(cached.url));
...
class CacheManagerKeyv {
    ...
    match(req, opts) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            addCacheHeaders(resHeaders, "", contentKey, redisInfo.integrity, redisInfo.time);
    ...
    opts) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (req.method === "HEAD" || response.status === 304) {
                ...
                addCacheHeaders(response.headers, "", contentKey, redisInfo.integrity, redisInfo.time);
